DROP TABLE IF EXISTS fai_bds_twitter_tweets_TABLESUFFIX_orc;
CREATE TABLE fai_bds_twitter_tweets_TABLESUFFIX_orc
(
...
INSERT OVERWRITE TABLE fai_bds_twitter_tweets_TABLESUFFIX_orc partition(year,month,day)
