-- Top ten products by quantity sold for Nov vs. YoY
...
FROM  (SELECT TO_CHAR(order_datetime, 'YYYY-MM') AS order_month
       ...
       WHERE (order_datetime BETWEEN timestamp '2010-11-01' AND timestamp '2010-11-30 23:59:59'
       OR     order_datetime BETWEEN timestamp '2009-11-01' AND timestamp '2009-11-30 23:59:59')
