-- Top ten products by quantity sold for Aug vs. YoY
...
FROM  (SELECT TO_CHAR(order_datetime, 'YYYY-MM') AS order_month
       ...
       WHERE (order_datetime BETWEEN timestamp '2010-08-01' AND timestamp '2010-08-30 23:59:59'
       OR     order_datetime BETWEEN timestamp '2009-08-01' AND timestamp '2009-08-30 23:59:59')
