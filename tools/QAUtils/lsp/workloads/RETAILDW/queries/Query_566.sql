-- List of customer IDs for customers who have bought kitchen but have not bought software
SELECT customer_id
FROM  (SELECT customer_id
       ,      SUM(CASE WHEN cat.category_name = 'Kitchen' THEN item_quantity ELSE 0 END) AS bought_quantity
