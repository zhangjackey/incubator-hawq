-- Top ten products by quantity sold for Dec vs. YoY
...
FROM  (SELECT TO_CHAR(order_datetime, 'YYYY-MM') AS order_month
       ...
       WHERE (order_datetime BETWEEN timestamp '2010-12-01' AND timestamp '2010-12-30 23:59:59'
       OR     order_datetime BETWEEN timestamp '2009-12-01' AND timestamp '2009-12-30 23:59:59')
