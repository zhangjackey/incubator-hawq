-- Top ten products by quantity sold for Sep vs. YoY
...
FROM  (SELECT TO_CHAR(order_datetime, 'YYYY-MM') AS order_month
       ...
       WHERE (order_datetime BETWEEN timestamp '2010-09-01' AND timestamp '2010-09-30 23:59:59'
       OR     order_datetime BETWEEN timestamp '2009-09-01' AND timestamp '2009-09-30 23:59:59')
