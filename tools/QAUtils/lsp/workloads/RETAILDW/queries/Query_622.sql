-- Top ten products by quantity sold for Jan vs. YoY
...
FROM  (SELECT TO_CHAR(order_datetime, 'YYYY-MM') AS order_month
       ...
       WHERE (order_datetime BETWEEN timestamp '2010-01-01' AND timestamp '2010-01-30 23:59:59'
       OR     order_datetime BETWEEN timestamp '2009-01-01' AND timestamp '2009-01-30 23:59:59')
