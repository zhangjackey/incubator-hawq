...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    from store_sales_TABLESUFFIX,date_dim_TABLESUFFIX,store_TABLESUFFIX,household_demographics_TABLESUFFIX,customer_address_TABLESUFFIX 
    ...
    and date_dim_TABLESUFFIX.d_dow in (6,0)
    and date_dim_TABLESUFFIX.d_year in (1999,1999+1,1999+2) 
    and store_TABLESUFFIX.s_city in ('Fairview','Midway','Fairview','Fairview','Fairview') 
    group by ss_ticket_number,ss_customer_sk,ss_addr_sk,ca_city) dn,customer_TABLESUFFIX,customer_address_TABLESUFFIX current_addr
